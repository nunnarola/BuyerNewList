...
public  DbBean(String sDBCon) {  // default constructor
	if (sDBCon != null){sDBConexct = sDBCon;}
	logger = Logger.getLogger("myLogger");
}
...
try {
    ...
    if (ssRs.next()) {
      ...
      inumberOfRows = 0;
      do {inumberOfRows++;} while(ssRs.next());
	...
	if (end - start > lLongThresh){new Common().LogAndNotifyMailOnly("SQLSelect in DB Bean Took "  + (end - start) + " to run: " +  sSQLStment);}
    sRetvl = null;

    if (ssRs != null){
      try{ssRs.close();} catch (SQLException e) { ; }
      ssRs=null;
    }
    if (ssStmt != null){
      try{ssStmt.close();} catch (SQLException e) { ; }
      ssStmt=null;
    }
    if (connection != null){
...
try {
  ...
  return false;
	...
	long end = new java.util.Date().getTime();
	if (end - start > lLongThresh){new Common().LogAndNotifyMailOnly(" Insertblob in DB Bean Took "  + (end - start) + " to run: " +  sSQLStment);}
  if (fis != null) {  try {fis.close();} catch (Exception ex) {     ; } } fis = null;
  if (rs != null) { try {rs.close();} catch (SQLException ex) {     ; } } rs = null;
  if (stmt != null) {     try {stmt.close();} catch (SQLException ex) {     ; } } stmt = null;
...
try {
  ...
  return null ;
	...
	long end = new java.util.Date().getTime();
	if (end - start > lLongThresh){new Common().LogAndNotifyMailOnly("SQLSelectBlob in DB Bean Took "  + (end - start) + " to run: " +  sSQLStment);}
  if (ssRs != null){
    try{ssRs.close();} catch (SQLException e) { ; }
    ssRs=null;
  }
...
try {
  ...
  return -1l;
	...
	long end = new java.util.Date().getTime();
	if (end - start > lLongThresh){new Common().LogAndNotifyMailOnly("SQLIns in DB Bean Took "  + (end - start) + " to run: " +  sSQLStment);}
  if (rs != null) { try {rs.close();} catch (SQLException ex) {     ; } } rs = null;
  if (stmt != null) {     try {stmt.close();} catch (SQLException ex) {     ; } } stmt = null;
  if (connection != null){ try{connection.close();} catch (SQLException e) {  ; }   }   connection = null;
...
return bSqlupinrv;
  ...
  return false;
	...
	long end = new java.util.Date().getTime();
	if (end - start > lLongThresh){new Common().LogAndNotifyMailOnly("SQLUpIns in DB Bean Took "  + (end - start) + " to run: " +  sSQLStment);}
  if (rs != null) { try {rs.close();} catch (SQLException ex) {     ; } } rs = null;
  if (stmt != null) {     try {stmt.close();} catch (SQLException ex) {     ; } } stmt = null;
  if (connection != null){ try{connection.close();} catch (SQLException e) {  ; }   }   connection = null;
...
try {
    ...
    if (ssRs.next()) {
      ...
      inumberOfRows = 0;
      do {inumberOfRows++;} while(ssRs.next());
      if (includeColNames) {inumberOfRows++;}
	...
	long end = new java.util.Date().getTime();
	if (!ignoreTiming && (end - start > lLongThresh)){new Common().LogAndNotifyMailOnly("PreparedSQLSelect in DB Bean Took "  + (end - start) + " to run: " +  sSQLStment);}
    sRetvl = null;
...
return lReV;
  ...
  return -3l;
	...
	long end = new java.util.Date().getTime();
	if (end - start > lLongThresh){new Common().LogAndNotifyMailOnly("PrepartedSQLIns in DB Bean Took "  + (end - start) + " to run: " +  sSQLStment);}	
  if (rs != null) { try {rs.close();} catch (SQLException ex) {     ; } } rs = null;
  if (stmt != null) {     try {stmt.close();} catch (SQLException ex) {     ; } } stmt = null;
  if (connection != null){ try{connection.close();} catch (SQLException e) {  ; }   }   connection = null;
...
return bSqlupinrv;
  ...
  return false;
	...
	long end = new java.util.Date().getTime();
	if (end - start > lLongThresh){new Common().LogAndNotifyMailOnly("PreparedSQLUpins in DB Bean Took "  + (end - start) + " to run: " +  sSQLStment);}
  if (rs != null) { try {rs.close();} catch (SQLException ex) {     ; } } rs = null;
  if (stmt != null) {     try {stmt.close();} catch (SQLException ex) {     ; } } stmt = null;
  if (connection != null){ try{connection.close();} catch (SQLException e) {  ; }   }   connection = null;
